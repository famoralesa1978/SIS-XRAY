(function (namespace, $) {
	...
	p._initPositionToastr = function () {
        ...
        $('.position-toastLogin').on('click', function (e) {
            toastr.options.hideDuration = 0;
            toastr.clear();
            o._toastrStateConfig();
            toastr.options.timeOut = 0;
            toastr.options.positionClass = $(e.currentTarget).data('position');
            toastr.error('El usuario o la contraseña incorrecta', '');
        });
	};
	...
	// =========================================================================
	namespace.UIMessages = new UIMessages;
