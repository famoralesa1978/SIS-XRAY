    ...
    public partial class Captcha : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			RectangleF oRectangleF = new RectangleF(0, 0, 300, 300);
					//	objBrush = new HatchBrush(aHatchStyles[objRandom.Next(aHatchStyles.Length - 3)], Color.FromArgb((objRandom.Next(100, 100)), (objRandom.Next(100, 100)), (objRandom.Next(100, 100))), Color.White);
						objBrush = new HatchBrush(aHatchStyles[objRandom.Next(aHatchStyles.Length - 3)], Color.FromArgb((objRandom.Next(100, 100)), (objRandom.Next(100, 100)), (objRandom.Next(100, 100))), Color.White);
